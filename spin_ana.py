...
def spin_ana(Ntoy, null="Z0", fitloop=1, sfit=True, cfit=True, param_file=None):
    ...
    for i in range(Ntoy):
        ...
        Sdnll, Cdnll = sig_test(sfit=True, cfit=True, null=null, alternative=alternative, param_file=param_file, fitloop=fitloop)
...
if __name__ == "__main__":
    SdNLL, CdNLL = spin_ana(100, null="Z0", fitloop=3, cfit=False) # edit
    print(f"########## deltaNLL for Sfit:\n{SdNLL}")
    print(f"########## deltaNLL for Cfit:\n{CdNLL}")